...
class AudioRecorder(private val context: Context) {
    ...
    fun startRecording(fileName: String): Boolean {
        try {
            ...
            for (config in configurations) {
                ...
                try {
                    ...
                    mediaRecorder = recorder.apply {
                        ...
                        // Set standard, safe parameters for maximum compatibility
                        if (isM4a) {
                            setAudioSamplingRate(16000) // 16000Hz is highly compatible and great for transcription
                            setAudioEncodingBitRate(64000)
                            setAudioChannels(1) // Mono
                        } else {
                            setAudioSamplingRate(8000) // AMR constraints
                            setAudioChannels(1)
                        }
            ...
            Log.e("AudioRecorder", "Global crash avoided in startRecording", globalEx)
    ...
    fun stopRecording(): File? {
        try {
            ...
            Log.e("AudioRecorder", "Global crash avoided in stopRecording", globalEx)
            globalEx.printStackTrace()
            return null
        }
    }
